      ...
      const renderActiveShape = (props) => {
        ...
        return (
          <g>
            ...
            <text style={{fontSize: "40px"}} x={cx} y={cy} dy={1} textAnchor="middle" >$16m</text>
            <text style={{fontSize: "20px"}} x={cx} y={cy} dy={25} textAnchor="middle" fill={fill}>{`${(percent * 100).toFixed(2)}%`}</text>
